    ...
    <div className="rounded-3xl border border-primary/15 bg-white p-6 shadow-sm">
      <div className="flex flex-col gap-6">
        <div className="flex items-center gap-2">
          ...
          <EditableField data={project.name} field="name" onUpdate={onUpdate}/>

          <StatusBadge status={project.derivedStatus} />
        </div>

        <div className="flex items-center gap-10">
          <EditableField data={project.description} field="description" onUpdate={onUpdate}/>

        </div>

        <div className="flex items-center gap-2">
          <EditableField data={project.dueDate} field="dueDate" onUpdate={onUpdate} />
        </div>
